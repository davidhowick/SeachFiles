                ...
                */
                private void initialize() {
                                ...
                                */
                                ...
                                /**
                                * Once the search button is pressed, the files are searched through, one by one, for keywords.
                                * @throws IOException
                                */
                                ...
                                btnSearch.addActionListener(new ActionListener() {
                                                public void actionPerformed(ActionEvent e) {
                                                        ...
                                                        try{
                                                            ...
                                                            while(s.hasNext()){
                                                               //read the document tokens into a binary tree data structure
                                                        ...
                                                        for(int p = 0; p <= separatedKeywords.length-1; p++){
                                                               exists = document.contains(separatedKeywords[p]); 
                                                                               if(exists == true){
                                                                                               count++; //increments each time a keyword is found in the document
                                                                               }       
                                                               }
                                                        //stores the keyword hits count in the file and the file name, in the 2D array
                                                        ranking.add(Integer.toString(count),files.get(counter));
                                               counter++; //increments through the linked linked list (to next text file)
                                               document.clear();
                                               count = 0;
                                                                                }
                                                                   ranking.partition(ranking.getArray(), 0, ranking.getArray().length-1);
                                                                   //StringBuilder used to to concatenate the hits count and the file stored in the 2D array
                                ...
                                /**
                                * Clear button resets variables to initial state 
                                 * so, the application can be used again 
                                 */
